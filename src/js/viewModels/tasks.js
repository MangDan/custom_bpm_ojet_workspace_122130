    ...
    function TasksViewModel() {
      ...
      self.handleActivated = function (info) {
        ...
        if (self.router) {
          ...
          oj.Logger.log("change to startTask module.");
          self.currentModule("startTask");
            ...
            .configure(
              {
                ...
                'taskDetail/{taskId}': { label: 'Task Detail' }
              });
      ...
      // To-Do : Module 정리
      self.currentModule = ko.observable("startTask");
      ...
      var tasksNavData = [
        {
          name: 'Start Task', id: 'startTask',
          iconClass: 'oj-navigationlist-item-icon demo-icon-font-24 demo-chart-icon-24'
        },
        {
          name: 'Assigned Task', id: 'assignedTask',
          iconClass: 'oj-navigationlist-item-icon demo-icon-font-24 demo-fire-icon-24'
        },
        {
          name: 'Completed Task', id: 'completedTask',
          iconClass: 'oj-navigationlist-item-icon demo-icon-font-24 demo-fire-icon-24'
        }
      ];
      ...
      self.dataSource = new oj.ArrayDataProvider(tasksNavData, { idAttribute: 'id' });
